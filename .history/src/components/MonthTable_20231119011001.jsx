...
export const MonthTable = () => {
  ...
  const updateCurrentData = (changedRows, type) => {
    ...
    switch (type) {
      case "H": {
        console.log('yep supper updating');
        ...
        if (existingData[selectedMonth].supperList) {
          existingData[selectedMonth].supperList = existingData[selectedMonth].supperList.map((supperItem) => {
            ...
            console.log('transformedChangedRows:', transformedChangedRows);
            return supperItem;
          });
        } else {
        ...
        // Log updated existingData for debugging
        console.log('existingData after update:', existingData);
      }
      break;
