      ...
      case "C":
        {
          if (existingData[selectedMonth].cleaningList?.length > 0) {
            existingData[selectedMonth].cleaningList = transformedChangedRows.map((changedRow) => {
              const matchingItem = existingData[selectedMonth].cleaningList.find(
                (changedItem) => {
                  return (
                    snackItem.familyEventDate == changedItem.familyEventDate
                  );
              ...
              if(matchingItem) {
                return { ...matchingItem, family: changedRow.family };
              }
            });
        break;
    }
