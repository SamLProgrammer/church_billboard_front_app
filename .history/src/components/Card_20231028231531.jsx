      ...
      <div className="wrapper">
        <div className="single-card">
          ...
          <div className="back" style={{ backgroundColor: colors[index] }}>
              <div onClick={() => {handleCardClick('Supper')}} style={{backgroundImage: 'url(../resources/supper.png)', backgroundSize: 'auto 100%', backgroundPosition: 'center center',}} className="option"></div>
