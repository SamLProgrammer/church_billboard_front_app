    ...
    if (error == null) {
      ...
      if (error == null) {
        ...
        availableMonths.forEach((month, index) => {
          monthsMap.set(month, index);
        });
        const monthsObject = Object.fromEntries(monthsMap);
        const monthsJSON = JSON.stringify(monthsObject);
        localStorage.setItem("monthsMap", monthsJSON);
        navigate("/months");
      }
    }
  };
