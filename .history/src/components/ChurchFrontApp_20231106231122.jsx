  ...
  const callUseValidateLogin = async () => {
    ...
    if (error == null) {
      ...
      if(error == null) {
        ...
        console.log(availableMonths);
        localStorage.setItem('generalData', JSON.stringify(availableMonths));
        console.log(JSON.parse(localStorage.getItem('generalData')));
        console.log(JSON.parse(localStorage.getItem('generalData'))['Enero']);
