...
const Card = ({ item, index }) => {
      ...
      const [monthData, setMonthData] = useState(new Map(Object.entries(JSON.parse(localStorage.getItem('monthsMap')))).get(item));
      ...
      useEffect(() => {
        if(monthData.supperList == null && monthData.sundaysList == null && monthData.snackList == null ) {
          fetchMonthData(item);
        }
      }, [])
