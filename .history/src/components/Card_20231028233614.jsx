      ...
      <div className="wrapper">
        <div className="single-card">
          ...
          <div className="back" style={{ backgroundColor: colors[index] }}>
              <div onClick={() => {handleCardClick('Supper')}} style={{background: 'url(https://www.flaticon.com/free-icons/last-supper)', backgroundSize: 'auto 100%', backgroundPosition: 'center center',}} className="option"></div>
