    ...
    <>
      <div className="wrapper">
        <div className="single-card">
          ...
          >{item}</div>
          <div className="back" style={{ backgroundColor: "#3399FF" }}>
              <div className="option" style={{ backgroundColor: "#33CA7F" }}>supper</div>
              <div className="option" style={{ backgroundColor: "#7DCFB6" }}>snack</div>
              <div className="option" style={{ backgroundColor: "#FBD1A2" }}>cleaning</div>
              <div className="option" style={{ backgroundColor: "#FC9F5B" }}>birthdates</div>
          </div>
        </div>
      </div>
    </>
