...
export const MonthTable = () => {
  ...
  return (
    <>
      ...
      <FamilyEventTable
        daysList={(type == 'H' || type == 'S') ? monthData.sundaysList : (type == 'C') ? monthData.saturdaysList : (type == 'B') ? monthData.monthDaysList : 'Error on Type'}
        recordsList={(type == 'H') ? monthData.supperList : (type == 'S') ? monthData.snackList : (type == 'C') ? monthData.cleaningList : (type == 'B') ? monthData.birthDaysList : 'Error on Type'}
